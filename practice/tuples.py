...
# ValueErros because i have more items in my tuple than i have variables to unpack too

# *allow a variable to hold multiple positions from a tuple
# unpack operator
